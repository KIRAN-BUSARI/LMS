...
const Footer = () => {
  ...
  return (
    <>
      {/* adding the footer */}
      <footer className="relative left-0 bottom-0 h-[10vh] py-5 flex flex-col sm:flex-row items-center justify-between sm:px-20 text-[#0095ff] bg-white">
        ...
        <section className="flex items-center justify-center gap-5 text-2xl text-[#0095ff]">
          ...
          <a
            className="hover:text-[#000] transition-all ease-in-out duration-300"
